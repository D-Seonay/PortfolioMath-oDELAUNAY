...
const ProjectNumber: React.FC<ProjectProps> = ({
  ...
  >
      <div className="w-[373px] h-[600px] p-1 rounded-[10px] my-5 md:m-9 flex-col justify-start items-start gap-[21px] inline-flex transition duration-300 ease-in-out transform hover:scale-105 bg-gradient-to-tr from-neutral-800 to-neutral-500  hover:from-secondary hover:to-primary hover:shadow-2xl">
