            ...
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="text-center text-white text-[25px] flex flex-col items-start">
                    ...
                    <div className="flex p-4 ">
                        <motion.button
                            className={`group flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-primary text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-secondary active:scale-105 dark:bg-white dark:bg-opacity-10 mx-3`}>
                                <a href="/docs/cv.pdf"
                                    target="_blank"
